    ...
    void CheckGrounded()
    {
        ...
        if(isGrounded && velocity.y < 0)
        {
            ...
            if(!wasGrounded && animator != null)
            {
                ...
                Debug.Log("착지");
                EffectManager.Instance.PlayEffect("착지이펙트", transform.position);
            }
        }
    }
    ...
    void HandleAttack()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1) && !isAttacking)
        {
            ...
            if (animator != null)
            {
                ...
                EffectManager.Instance.PlayEffectWithDelay("공격이펙트", effectPos.transform.position, Quaternion.identity, 0.5f, 0.1f);
            }
        }
    }
